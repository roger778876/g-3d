...
def add_sphere(points, cx, cy, cz, r, step):
  ...
  for point in sphere_matrix:
    add_edge(points, point[0], point[1], point[2], point[0], point[1] + 1, point[2])

def generate_sphere(points, cx, cy, cz, r, step):
  sphere_matrix = new_matrix(4,0)
  for i in range(step):
